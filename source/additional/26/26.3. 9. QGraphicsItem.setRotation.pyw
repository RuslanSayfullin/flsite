...
def on_clicked():
    view.setFocus()
    my_item.setRotation(0.0)
    my_item.setScale(1.0)
...
my_item.setTransformOriginPoint(0, 0)
my_item.setRotation(45.0)
my_item.setScale(0.5)

scene.addItem(my_item)

view = QtWidgets.QGraphicsView(scene)

button = QtWidgets.QPushButton("Сбросить трансформацию")
