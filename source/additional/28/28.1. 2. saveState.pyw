...
class MyWidget(QtWidgets.QWidget):
    def __init__(self, parent=None):
        ...
        self.button = QtWidgets.QPushButton("Сохранить положение")
        self.button2 = QtWidgets.QPushButton("Восстановить положение")
...
class MyWindow(QtWidgets.QMainWindow):
    ...
    def add_tool_bar(self):
        ...
        self.toolBar2.setObjectName("MyToolBar2")
    ...
    def add_dock_widget(self):
        ...
        self.dw2.setObjectName("MyDockWidget2")
        ...
        self.dw3.setObjectName("MyDockWidget3")
        ...
        self.dw4.setObjectName("MyDockWidget4")
    ...
    def on_clicked_button1(self):
        self.data_state = self.saveState()
        self.date_geometry = self.saveGeometry()

    def on_clicked_button2(self):
        if self.data_state is not None:
            self.restoreState(self.data_state)
        if self.date_geometry is not None:
            self.restoreGeometry(self.date_geometry)
