...
class MyWidget(QtWidgets.QWidget):
    def __init__(self, parent=None):
        ...
        self.button = QtWidgets.QPushButton(
            "Сделать панель отдельным окном")
...
class MyWindow(QtWidgets.QMainWindow):
    ...
    def add_dock_widget(self):
        ...
        self.dw.setAllowedAreas(QtCore.Qt.DockWidgetArea.LeftDockWidgetArea)
        ...
        self.dw3.setAllowedAreas(QtCore.Qt.DockWidgetArea.AllDockWidgetAreas)
        ...
        self.dw4.setAllowedAreas(QtCore.Qt.DockWidgetArea.AllDockWidgetAreas)
    ...
    def on_clicked(self):
        self.dw4.setFloating(not self.dw4.isFloating())
